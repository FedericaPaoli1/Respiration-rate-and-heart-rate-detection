...
% of 0.16 Hz for 12 cycles of inhalation and exhalation 
...
% file: signals/pos1_accelerometer_data_6sbreathing.txt
%
% They were recorded with a sampling rate of 202 Hz and 
% a resolution of 0.244 mg/LSB

fprintf('Loading of pos1_accelerometer_data_6sbreathing.txt  \n');
load signals/pos1_accelerometer_data_6sbreathing.txt % data composed by the following columns: time, gFx, gFy, gFz, TgF
...
[~,uidx] = unique(pos1_accelerometer_data_6sbreathing(:,1),'stable');
pos1_accelerometer_data = pos1_accelerometer_data_6sbreathing(uidx,:);
...
figure(1)
signals_plotting(pos1_accelerometer_data, pos1_timeAxis, 'Pos1-accelerometer-data-6sbreathing')
...
figure(4)
signals_filtered_plotting(pos1_accelerometer_data, pos1_accelerometer_data_filtered, pos1_timeAxis, 'Pos1-accelerometer-data-6sbreathing')
...
figure(5)
yAxis_filtered_plotting(pos1_y, pos1_y_filtered, pos1_timeAxis, 'Pos1-accelerometer-data-6sbreathing')
...
% plot the original data and the filtered data
figure(11)
signals_filtered_plotting(pos1_accelerometer_data, pos1_accelerometer_data_bandpassed, pos1_timeAxis, 'Pos1-accelerometer-data-6sbreathing')

% plot the y axis of the original and the filtered data
pos1_z = pos1_accelerometer_data(:,4);
pos1_z_filtered = pos1_accelerometer_data_bandpassed(:,4);
figure(12)
zAxis_filtered_plotting(pos1_z, pos1_z_filtered, pos1_timeAxis, 'Pos1-accelerometer-data-6sbreathing')
...
% plot the original data and the filtered data
figure(14)
signals_filtered_plotting(pos2_accelerometer_data, pos2_accelerometer_data_bandpassed, pos2_timeAxis, 'Pos2-accelerometer-data-6sbreathing')
...
figure(16)
signals_heart_rate_plotting_1(pos1_accelerometer_data, pos1_accelerometer_data_bandpassed, pos2_accelerometer_data, pos2_accelerometer_data_bandpassed, pos1_timeAxis, pos2_timeAxis, 'Pos1-accelerometer-data-6sbreathing', 'Pos2-accelerometer-data-6sbreathing')

figure(17)
signals_heart_rate_plotting_2(pos1_z_filtered, pos2_y_filtered, pos1_timeAxis, pos2_timeAxis, 'accelerometer-data-6sbreathing')
