...
% with a respiratory frequency of 0.0625 Hz for 12 cycles of inhalation and exhalation 
...
% file: signals/pos2_accelerometer_data_16sbreathing.txt
%
...
figure(3)
signals_filtered_plotting(pos2_accelerometer_data, pos2_accelerometer_data_filtered, pos2_timeAxis, 'Pos2-accelerometer-data-16sbreathing')
