...
% with a respiratory frequency of 0.083 Hz for 12 cycles of inhalation and exhalation 
...
% file: signals/pos2_accelerometer_data_12sbreathing.txt
%
...
figure(3)
signals_filtered_plotting(pos2_accelerometer_data, pos2_accelerometer_data_filtered, pos2_timeAxis, 'Pos2-accelerometer-data-12sbreathing')
